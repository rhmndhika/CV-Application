        ...
        <Box
          ...
          <Stack spacing={4}>
            ...
            <FormControl id="nationality" isRequired>
              ...
              <Input type="text" value={data.Nationality} onChange={(e) => setData({...data, Nationality: e.target.value})} />
            </FormControl>
        ...
        <Box
          ...
          <Stack spacing={4}>
            ...
            <FormControl id="GraduationDate">
                ...
                <Input type="date" value={data.GraduationDate} onChange={(e) => setData({...data, GraduationDate: e.target.value})} />
            </FormControl>
            <FormControl id="Qualification" isRequired>
              <FormLabel>Qualification</FormLabel>
              <Input type="text" value={data.Qualification} onChange={(e) => setData({...data, Qualification: e.target.value})} />
            </FormControl>
            <FormControl id="Major" isRequired>
              <FormLabel>Major</FormLabel>
              <Input type="text" value={data.Major} onChange={(e) => setData({...data, Major: e.target.value})} />
            </FormControl>
          ...
          <Stack spacing={4}>
            ...
            <Box>
                <FormControl id="MonthEntry" isRequired>
                    ...
                    <Input type="date" value={data.MonthEntry} onChange={(e) => setData({...data, MonthEntry: e.target.value})} />
                </FormControl>
            </Box>
            <Box>
                <FormControl id="MonthLeave" isRequired>
                    <FormLabel>Month Leave</FormLabel>
                    <Input type="date" value={data.MonthLeave} onChange={(e) => setData({...data, MonthLeave: e.target.value})} />
                </FormControl>
            </Box>
            </HStack>
            <FormControl id="FieldOfWork" isRequired>
              <FormLabel>Field Of Work</FormLabel>
              <Input type="text" value={data.FieldOfWork} onChange={(e) => setData({...data, FieldOfWork: e.target.value})} />
            </FormControl>
            <FormControl id="Industry" isRequired>
              <FormLabel>Industry</FormLabel>
              <Input type="text" value={data.FieldIndustryOfWork} onChange={(e) => setData({...data, Industry: e.target.value})} />
            </FormControl>
            <FormControl id="JobDescription" isRequired>
              <FormLabel>Job Description</FormLabel>
              <Textarea placeholder='Your job description..' value={data.JobDescription} onChange={(e) => setData({...data, JobDescription: e.target.value})} />
            </FormControl>
          </Stack>
        </Box>
      </Stack>
  ...
  return (
    ...
    :
        <Box
          ...
          m="10px auto"
          as="form">
          {step === 1 ? <Form1 data={dataFormSatu} setData={setDataFormSatu} /> : step === 2 ? <Form2 data={dataFormSatu} setData={setDataFormSatu} /> : 
